...
export default function WhatsAppFloatButton({ message }: { message?: string }) {
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-50 bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg px-5 py-3 flex items-center gap-2 transition-colors"
    >
